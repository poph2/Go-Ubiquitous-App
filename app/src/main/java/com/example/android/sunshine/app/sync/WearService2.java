...
/**
 * Created by Pop H2 on 10/6/2016.
 * Pop Inc
 * Lagos Nigeria
 */
public class WearService2 extends IntentService implements
        GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {

    private static String TAG = WearService2.class.getSimpleName();
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null
            ...
            mGoogleApiClient = new GoogleApiClient.Builder(WearService2.this)
